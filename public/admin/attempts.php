<?php require_once __DIR__.'/../../config/db.php'; require_admin(); require_once __DIR__.'/../../includes/header.php'; require_once __DIR__.'/_side_nav.php';
...
if(isset($_GET['export']) && $_GET['export']==='csv'){
    header('Content-Type: text/csv'); header('Content-Disposition: attachment; filename="attempts_export.csv"');
    $out = fopen('php://output','w'); fputcsv($out, ['id','user','email','exam','score','total','completed_at']);
...
<table class="table"><thead><tr><th>ID</th><th>User</th><th>Exam</th><th>Score</th><th>Date</th></tr></thead><tbody><?php foreach($rows as $r): ?><tr><td><?php echo e($r['id']); ?></td><td><?php echo e($r['user_name']); ?> (<?php echo e($r['user_email']); ?>)</td><td><?php echo e($r['exam_title']); ?></td><td><?php echo e($r['score']); ?> / <?php echo e($r['total_questions']); ?></td><td><?php echo e($r['completed_at']); ?></td></tr><?php endforeach; ?></tbody></table>
